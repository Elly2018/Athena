...
public class GemRingRed extends RPGEquip_Header {

    static class GemRingRed_RPG_Equip extends RPGEquip_Base {
        public GemRingRed_RPG_Equip(Properties properties) {
            super(properties);
    ...
    public Item get_binding(Item.Properties props) {
        return new GemRingRed_RPG_Equip(props);
    }
}

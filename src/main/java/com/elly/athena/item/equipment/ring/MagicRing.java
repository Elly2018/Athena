...
public class MagicRing extends RPGEquip_Header {

    static class MagicRing_RPG_Equip extends RPGEquip_Base {
        public MagicRing_RPG_Equip(Properties properties) {
            super(properties);
    ...
    public Item get_binding(Item.Properties props) {
        return new MagicRing_RPG_Equip(props);
    }
}

...
public class OrcsNecklace extends RPGEquip_Header {

    static class OrcsNecklace_RPG_Equip extends RPGEquip_Base {
        public OrcsNecklace_RPG_Equip(Properties properties) {
            super(properties);
    ...
    public String get_key() {
        return "necklace_orcs";
    }

    @Override
    public Item get_binding(Item.Properties props) {
        return new OrcsNecklace_RPG_Equip(props);
    }
}

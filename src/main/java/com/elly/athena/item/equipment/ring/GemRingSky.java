...
public class GemRingSky extends RPGEquip_Header {

    static class GemRingSky_RPG_Equip extends RPGEquip_Base {
        public GemRingSky_RPG_Equip(Properties properties) {
            super(properties);
    ...
    public Item get_binding(Item.Properties props) {
        return new GemRingSky_RPG_Equip(props);
    }
}

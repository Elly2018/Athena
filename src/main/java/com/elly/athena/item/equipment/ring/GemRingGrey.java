...
public class GemRingGrey extends RPGEquip_Header {

    static class GemRingGrey_RPG_Equip extends RPGEquip_Base {
        public GemRingGrey_RPG_Equip(Properties properties) {
            super(properties);
    ...
    public String get_key() {
        return "ring_gem_grey";
    }

    @Override
    public Item get_binding(Item.Properties props) {
        return new GemRingGrey_RPG_Equip(props);
    }
}

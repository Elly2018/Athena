...
public class DataComponent_Register {
    ...
    public static final Supplier<DataComponentType<ItemEquip.ItemEquipRecord>> EQUIP = REGISTRAR.registerComponentType("equip", builder -> builder.persistent(ItemEquip.CODEC).networkSynchronized(ItemEquip.STREAM_CODEC));

...
public class DataComponent_Register {
    ...
    public static final Supplier<DataComponentType<ItemEquip.ItemEquipRecord>> EQUIP = REGISTRAR.registerComponentType("upgrade", builder -> builder.persistent(ItemEquip.CODEC).networkSynchronized(ItemEquip.STREAM_CODEC));
